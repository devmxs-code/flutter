...
import 'package:whatsappclone2021/models/chat_model.dart';
import 'package:whatsappclone2021/components/custom_appbar.dart';

import '../bottom_navigation_icons_icons.dart';
            ...
            delegate:
              ...
              return Column(
                children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            color: dummyChatsData[index].time.endsWith('M')
                                ? const Color(0xFF3C9EF6)
                                : const Color(0xFF79787B),
                          ),
                        ),
                      ],
                    ),
                  ...
                  const Padding(
                    padding: EdgeInsets.only(left: 83.0, right: 5),
                    child: Divider(
                      height: 8.0,
                      color: Color(0xFF7C7B84),
                    ),
